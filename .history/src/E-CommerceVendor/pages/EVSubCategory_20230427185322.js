        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Select aria-label="Default select example" className="mb-3">
              ...
              <option>SHiets</option>
            </Form.Select>
            <Button    style={{ backgroundColor: "#576cbc", borderRadius: "0" , border : '1px solid #576cbc' }} type="submit">
              Submit
            </Button>
          </Form>
        </Modal.Body>
...
export default HOC(EVSubCategory)