...
const Horoscope = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const ViewSingle = async () => {
      try {
        const { data } = await axios.get(
          `https://xlweh818ib.execute-api.ap-south-1.amazonaws.com/dev/horoscope/${id}`
        );
        setItem(data);
      } catch (e) {
        console.log(e);
  ...
  return (
    <>
      ...
      <p className="headP">Dashboard / Horoscopes</p>
      ...
      <section>
        ...
        >
          ...
          <button
            ...
            className="md:py-2 px-3 md:px-4 py-1 rounded-sm bg-[#2b7a8e] text-white tracking-wider"
            style={{ textTransform: "uppercase" }}
          >
            Add Horoscropes
          </button>
