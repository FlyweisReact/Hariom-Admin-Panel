      ...
      >
        ...
        <Modal.Body>
          <Container>
            ...
            <p className="View">
              {" "}
              <strong> About</strong> :  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'sstandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type{" "}
            </p>
          </Container>
        </Modal.Body>
      </Modal>
