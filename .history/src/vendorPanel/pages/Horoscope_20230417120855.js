    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          {edit ? (
            <>
              <p className="View"> <strong>Professional</strong> : Demo </p>
              <p className="View"> <strong>Emotions</strong> : Demo </p>
              <p className="View"> <strong>Health</strong> : Demo </p>
              <p className="View"> <strong>Finance</strong> : Demo </p>
