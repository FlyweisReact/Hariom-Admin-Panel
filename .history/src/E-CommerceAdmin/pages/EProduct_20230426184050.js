    ...
    <>
      ...
      />
        ...
        <div className="pb-4 sticky top-0  w-full flex justify-between items-center" style={{width : '98%' , marginLeft : '2%'}}>
          <span className="tracking-widest text-slate-900 font-semibold uppercase" style={{fontSize : '2rem'}}>
            All Product's
          </span>
          <button
            onClick={() => {
        ...
        <section style={{width : '98%' , backgroundColor : '#fff' , marginLeft : '2%' ,padding : '20px'}}>
        <Table>
          <thead>
            <tr>
              <th>Name</th>
              ...
              <tr key={index}>
                ...
                <td>
                  <span className="flexCont">
                    ...
                    ></i>
                    <i class="fa-sharp fa-solid fa-trash" onClick={() => deleteHandler()}></i>
                  </span>
                </td>
              </tr>
            ))}
