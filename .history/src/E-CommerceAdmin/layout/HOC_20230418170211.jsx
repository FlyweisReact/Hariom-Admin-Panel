...
const HOC = (Wcomponenet) => {
  return function Component() {
    ...
    return (
      <>
        <section className="flex overflow-x-hidden relative bggg" >
          {/* Sidebar */}
          <div
            className={
              hamb
          ...
          <div
            className={
              hamb
                ? " transition-all px-4 py-2  duration-150 w-full h-screen bggg"
                : " w-full h-screen  px-4 py-2  bg-white z-50 transition-all  duration-150 bggg"
            }
          >
            <Navbar hamb={hamb} setHamb={setHamb} />
            <div className="my-6 text-#000 h-[87%] wcomp overflow-y-auto bggg">  <Wcomponenet  />
            </div>
          </div>
        </section>
      </>
