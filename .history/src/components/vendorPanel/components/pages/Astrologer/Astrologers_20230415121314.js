      ...
      >
        ...
        <Modal.Body>
          <Container>
            ...
            <p className="View"> <strong></strong>  Description : Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'sstandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type  </p>
            <p className="View">  <strong></strong> Language : Demo  </p>
            <p className="View"> <strong></strong> Experience : Demo  </p>
            <p className="View"> <strong></strong> Rating : Demo  </p>
            <p className="View"> <strong></strong> Price per min : Demo  </p>
            <p className="View"> <strong></strong> Discounted Price per min : Demo  </p>
            <p className="View"> <strong></strong>  Expertise : Demo  </p>
