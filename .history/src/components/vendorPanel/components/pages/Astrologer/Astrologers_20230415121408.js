  ...
  function ViewModal(props) {
    return (
      ...
      >
        ...
        <Modal.Body>
          <Container>
            <p className="View"> <strong>Name </strong>   : Demo  </p>
            <p className="View"> <strong >  Expert Tag </strong>  : Demo  </p>
            <p className="View"> <strong >  Description </strong>  : Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'sstandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type  </p>
            <p className="View">  <strong> Language </strong>  : Demo  </p>
            <p className="View"> <strong> Experience</strong> : Demo  </p>
            <p className="View"> <strong> Rating</strong> : Demo  </p>
            <p className="View"> <strong>  Price per min </strong> : Demo  </p>
            <p className="View"> <strong>Discounted Price per min</strong>  : Demo  </p>
            <p className="View"> <strong> Expertise </strong> : Demo  </p>
            <p className="View"> <strong> Skills </strong>  : Demo  </p>
            <p className="View"> <strong>  Min. of consultation </strong> : Demo  </p>
            <p className="View">  <strong></strong> About : Demo  </p>
          </Container>
        </Modal.Body>
      </Modal>
    );
