    ...
    <>
      ...
      >
        <form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 ">
          <p className="text-3xl" style={{  color : "#2b7a8e" , fontWeight : 'bold'}}> Astrologer Admin Panel </p>
          <section className="py-7">
            ...
            <button
              type="submit"
              className="py-2 cursor-pointer tracking-wider bg-orange-600 flex justify-center items-center w-full rounded-md font-medium  mt-3 "
            ...
            >
              E-Commerce Admin Panel ecommerce 
            </button>
            <button
              type="button"
              onClick={() => navigate("/")}
